...
$CustomerId = 'dfdfdfdfdfdfdfdfdfdfdf'  # Change the customerID of your log analytics workspace as per your tenant

# Replace with your Primary Key
$SharedKey = 'dfdfdfdfdfdf' # Change the sharedKey/Primary key of your log analytics workspace.

#Control if you want to collect App or Device Inventory or both (True = Collect)
$CollectAutopilotHashInfo = $true
$AutopilotHashInfoLogName = 'AutopilotHashID' #This will be the table that gets created in Log analytics specified above if not exist.
$Date = (Get-Date)
...
try {
	...
	Write-host "Failed to retrieve information: $_"
}
$deviceInfo

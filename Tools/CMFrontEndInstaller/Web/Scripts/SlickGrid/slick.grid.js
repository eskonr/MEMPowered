...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function flashRow(row, speed) {
        ...
        if (rowsCache[row]) {
            ...
            function toggleRowClass(times) {
                ...
                setTimeout(function () {
                    for (var $cell in $rowa.cellNodesByColumnIdx) {
                        var $cellNode = $rowa.cellNodesByColumnIdx[$cell];
                        $($cellNode).queue(function () {
                            $($cell).toggleClass(options.cellFlashingCssClass).dequeue();
                        });
                    }
                    $($row).queue(function () {
                        $($row).toggleClass(options.cellFlashingCssClass).dequeue();
    ...
    function flashRowId(id, speed) {
        for (var row in rowsCache) {
            ensureCellNodesInRowsCache(row);
            var rowData = getDataItem(row);
            if (rowData.id == id) {
